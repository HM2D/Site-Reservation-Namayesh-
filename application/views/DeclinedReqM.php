    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <p class="text-default pull-left"><span class="badge badge-danger"><?php echo date('F d , H:i', strtotime($row['SentDateTime'])); ?></span></p>
         <form method="post" action="<?php echo base_url('/index.php/ActionController/DeleteApprovedReqM/'.rtrim(base64_encode(base_url('/index.php/'. uri_string())), '=')); ?> ">
        <button type="submit" class="btn btn-danger" name="deleteButton" value="<?php echo $row['idRequests']; ?>" >Delete</button></form>
